...
namespace ExamenParcial2_Progra3.Controllers
{
    public class MetasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descripcion,FechaCreacion,FechaLimite,CategoriaMetaId,PrioridadMetaId,EstadoMetaId")] Meta meta)
        {

            //Validar el titulo no esta vacio
            ...
            {
                ModelState.AddModelError(string.Empty, "Ocurrió un error al crear la meta: " + ex.Message);
                }
